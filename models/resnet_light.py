...
def ResNet18(num_classes=10,name=None, created_time=None):
    return ResNet(BasicBlock, [2,2,2,2],num_classes=num_classes,name='{0}_ResNet_18'.format(name), created_time=created_time)
